...
<!--end header-->
    ...
    <ul class="nav-list">
        ...
        <main class="l-main js-main">
            ...
            <div class="single">
                <img src="{{ asset('storage/upload/'.$postblog->blogpic) }}" alt="" class="single-image">
                <div class="l-container u-clear">
                    <h1 class="single-title">{{$postblog->blogtitle}}</h1>
                    <time class="single-date" datetime="">{{\Carbon\Carbon::parse($postblog->blogdate)->format('d M, Y')}}</time>
                    <p class="single-desc">{{$postblog->blogdesc}}</p>
